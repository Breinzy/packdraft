        ...
        {historyJob ? (
          <div className="panel p-4 space-y-2">
            ...
            <div className="text-sm text-foreground">
              ...
              {historyJob.stop_reason ? `last stop: ${historyJob.stop_reason}` : 'paused until you resume'}
            </div>
            <div className="grid grid-cols-2 md:grid-cols-4 gap-2 text-xs text-muted">
            ...
            <p className="text-xs text-faint">
              ...
              anything held in a Packdraft book. Zero-volume filler is skipped. Set 24h/30d indexes
              use these snapshots; they stay 0 until a prior observation exists.
            </p>
