...
export default function SignupPage() {
  ...
  return (
    <AuthShell title="Create an account" subtitle="Track your Pokémon collection against live market data. Tournaments are optional.">
      <button onClick={handleGoogleSignup} className="btn btn-ghost w-full min-h-12 gap-3">
