...
2. Run, in order (skip a file if it was already applied):
   ...
   - `supabase/migrations/20260904120000_set_indexes.sql`
3. In Table Editor, confirm `assets`, `tcgs`, `tournaments`, `market_job_state`, `career_portfolios`, `friendships`, `release_campaigns`, `asset_market_stats`, and `set_latest_indexes` exist.
