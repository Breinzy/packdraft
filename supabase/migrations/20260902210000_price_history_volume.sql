-- One-pass PPT 6-month history + volume, then daily updates by priority.
-- ETBs and booster boxes are always-daily. High-volume cards are next.
-- history_backfill starts paused so it cannot spend PPT credits until an admin resumes it.
